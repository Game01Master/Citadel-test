...
// Auto-import all troop icons from ./icons (Vite)
...
function iconSrcForTroop(name) {
  ...
  if (!file) return null;
  // Prefer bundled icon (src/icons) if present; fallback to public/icons
  return ICON_MODULES[`./icons/${file}`] || `${ICON_BASE}icons/${encodeURIComponent(file)}`;
}
