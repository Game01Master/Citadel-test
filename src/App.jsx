...
function usePrefersDark() {
  ...
  useEffect(() => {
    fetch("https://api.countapi.xyz/hit/game01master-citadel/visits")
      .then(r => r.json())
      .then(data => setGlobalVisits(data.value))
      .catch(() => {});
  }, []);
...
export default function App() {
  ...
  const showResults = () => {
    fetch("https://api.countapi.xyz/hit/game01master-citadel/calculates")
      .then(r => r.json())
      .then(data => setGlobalCalculates(data.value))
      .catch(() => {});
