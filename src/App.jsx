    ...
    >
      <div
        ...
        style={{
          width: "100%",
          maxWidth: 500,
          background: "linear-gradient(180deg, rgba(24,26,32,0.98) 0%, rgba(14,15,18,0.98) 100%)",
          color: theme.text,
          borderRadius: 16,
          ...
          <Card title="⚙️ Setup" theme={theme}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              <label style={{ display: "grid", gap: 8 }}>
                ...
                <select className="gm-select" value={mode} onChange={(e) => handleModeChange(e.target.value)} style={inputStyle}>
              ...
              <label style={{ display: "grid", gap: 8 }}>
                ...
                <select className="gm-select" value={citadelLevel} onChange={(e) => { setCitadelLevel(e.target.value); setCalcOutput(null); setResultsOpen(false); }} style={inputStyle}>
