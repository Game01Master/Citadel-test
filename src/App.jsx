  ...
  return (
    <div
      style={{
        ...
        backgroundSize: isDesktop ? "100% auto" : "cover",
...
`}</style>
      ...
      <div style={{ width: "100%", maxWidth: isDesktop ? 980 : 600, margin: "0 auto", padding: "20px 16px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: isDesktop ? 980 : 600, margin: "0 auto" }}>
